...
Source0  : https://download.kde.org/stable/frameworks/6.4/frameworkintegration-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/frameworkintegration-6.4.0.tar.xz.sig
...
%setup -q -n frameworkintegration-6.4.0
cd %{_builddir}/frameworkintegration-6.4.0
pushd ..
cp -a frameworkintegration-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721059096
mkdir -p clr-build
pushd clr-build
