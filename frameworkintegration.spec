...
Version  : 6.14.0
Release  : 94
URL      : https://download.kde.org/stable/frameworks/6.14/frameworkintegration-6.14.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/frameworkintegration-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/frameworkintegration-6.14.0.tar.xz.sig
...
%setup -q -n frameworkintegration-6.14.0
cd %{_builddir}/frameworkintegration-6.14.0
pushd ..
cp -a frameworkintegration-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747192917
mkdir -p clr-build
pushd clr-build
