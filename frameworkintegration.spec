...
Source0  : https://download.kde.org/stable/frameworks/5.60/frameworkintegration-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/frameworkintegration-5.60.0.tar.xz.sig
...
%prep
%setup -q -n frameworkintegration-5.60.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563072650
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Style.so.5.60.0
