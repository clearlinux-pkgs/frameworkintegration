...
Source0  : https://download.kde.org/stable/frameworks/5.109/frameworkintegration-5.109.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.109/frameworkintegration-5.109.0.tar.xz.sig
...
%prep
%setup -q -n frameworkintegration-5.109.0
cd %{_builddir}/frameworkintegration-5.109.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693246929
mkdir -p clr-build
pushd clr-build
...
%files
%defattr(-,root,root,-)
/V3/usr/lib64/libexec/kf5/kpackagehandlers/knshandler
