...
Source0  : https://download.kde.org/stable/frameworks/5.85/frameworkintegration-5.85.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.85/frameworkintegration-5.85.0.tar.xz.sig
...
%prep
%setup -q -n frameworkintegration-5.85.0
cd %{_builddir}/frameworkintegration-5.85.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630905173
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/frameworkintegration-5.85.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/frameworkintegration/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/frameworkintegration-5.85.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/frameworkintegration/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/frameworkintegration-5.85.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/frameworkintegration/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/frameworkintegration-5.85.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/frameworkintegration/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/frameworkintegration-5.85.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/frameworkintegration/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Style.so.5.85.0
