...
Source0  : https://download.kde.org/stable/frameworks/5.62/frameworkintegration-5.62.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.62/frameworkintegration-5.62.0.tar.xz.sig
...
%prep
%setup -q -n frameworkintegration-5.62.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568944657
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Style.so.5.62.0
