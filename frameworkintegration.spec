...
Version  : 6.5.0
Release  : 85
URL      : https://download.kde.org/stable/frameworks/6.5/frameworkintegration-6.5.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.5/frameworkintegration-6.5.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.5/frameworkintegration-6.5.0.tar.xz.sig
...
%setup -q -n frameworkintegration-6.5.0
cd %{_builddir}/frameworkintegration-6.5.0
pushd ..
cp -a frameworkintegration-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723474627
mkdir -p clr-build
pushd clr-build
