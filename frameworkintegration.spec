...
Version  : 6.0.0
Release  : 73
URL      : https://download.kde.org/stable/frameworks/6.0/frameworkintegration-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.0/frameworkintegration-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/frameworkintegration-6.0.0.tar.xz.sig
...
%prep
%setup -q -n frameworkintegration-6.0.0
cd %{_builddir}/frameworkintegration-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709310374
mkdir -p clr-build
pushd clr-build
