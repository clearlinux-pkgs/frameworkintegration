...
Source0  : https://download.kde.org/stable/frameworks/5.97/frameworkintegration-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/frameworkintegration-5.97.0.tar.xz.sig
...
%prep
%setup -q -n frameworkintegration-5.97.0
cd %{_builddir}/frameworkintegration-5.97.0
...
/usr/lib64/libKF5Style.so.5.97.0
