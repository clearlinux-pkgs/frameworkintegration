...
Source0  : https://download.kde.org/stable/frameworks/5.103/frameworkintegration-5.103.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.103/frameworkintegration-5.103.0.tar.xz.sig
...
%prep
%setup -q -n frameworkintegration-5.103.0
cd %{_builddir}/frameworkintegration-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676831609
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Style.so.5.103.0
