...
Version  : 6.12.0
Release  : 92
URL      : https://download.kde.org/stable/frameworks/6.12/frameworkintegration-6.12.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.12/frameworkintegration-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/frameworkintegration-6.12.0.tar.xz.sig
...
%setup -q -n frameworkintegration-6.12.0
cd %{_builddir}/frameworkintegration-6.12.0
pushd ..
cp -a frameworkintegration-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742575626
mkdir -p clr-build
pushd clr-build
